...
//        Core.inRange(input, blueLowHSV, blueHighHSV, blueMask);
//        Core.inRange(input, yellowLowHSV, yellowHighHSV, yellowMask);
//        Core.inRange(input, redLowHSV1, redHighHSV1, redMask1);
//        Core.inRange(input, redLowHSV2, redHighHSV2, redMask2);
//        Core.bitwise_or(redMask1, redMask2, redMask);
//
//        Mat totalMask = new Mat();
//        Core.bitwise_or(blueMask, yellowMask, totalMask);
//        Core.bitwise_or(totalMask, redMask, totalMask);
//
//        Mat output = new Mat();
